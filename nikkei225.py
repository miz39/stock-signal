"""
日経平均株価（Nikkei 225）構成銘柄一覧
Ticker codes in "XXXX.T" format (Tokyo Stock Exchange) mapped to Japanese company names.
Source: Diamond ZAi Online, Traders Web (as of March 2026)
"""
